...
export function DocServiceInfoScreen({navigation,route}) {
    const {service} = route.params;

    function delSer() {
        const ser = new Service(service.id,service.name,service.descrizione,service.costo);
        ser.deleteService();
        navigation.goBack();
    }
    ...
    return (
        <SafeAreaView style={styles.container}>
            <View style={styles.upperView}>
                ...
                />
                <Text style={{marginBottom:"33%",fontWeight:'bold',fontSize:30,color:'#fb5b5a'}}>SERVICE INFO:</Text>
                <View style={{flexDirection: 'row',width:"85%",height:"20%",justifyContent:'space-between',alignItems:'center'}}>
                    <TouchableOpacity onPress={() => navigation.goBack()}>
                        <MaterialIcons name="arrow-back" size={30} color="white" />
                    </TouchableOpacity>
                    <TouchableOpacity onPress={()=> delSer()}>
                        <FontAwesome5 name="trash" size={27} color="white" />
                    </TouchableOpacity>
    ...
    img2Style: {
        ...
        /*<SafeAreaView style={{flex: 1}}>
            <View style={styles.container}>
                ...
                <TouchableOpacity style={{marginTop:"5%",alignItems:'flex-end',width:"80%"}}
                onPress={()=> delSer()}>
